...
const storageKey = "golf-roulette-active-round-v3";
...
export default function GameScreen({ holes = 9, names = ["You", "Player 2"] }) {
  ...
  const completeHole = () => {
    ...
    // Every player spins once on every hole. Only advance the hole after the last player finishes.
  ...
  if (finished) return (
    <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.finishWrap}>
      ...
      <Text style={styles.finishSub}>{holes} holes · {players.length} players · {holes * players.length} draws · chaos mode</Text>
...
const styles = StyleSheet.create({
  ...
  card: { width: "100%", backgroundColor: "#101612", borderRadius: 18, padding: 20, borderWidth: 1, borderColor: "#29352e", flex: 1, minHeight: 210 }, cardTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }, forText: { color: "#6d7972", fontSize: 9, fontWeight: "900", letterSpacing: 1.2, marginTop: 5 }, pointsBadge: { width: 52, height: 52, borderRadius: 26, backgroundColor: "#b8d86a", alignItems: "center", justifyContent: "center" }, points: { color: "#09100c", fontSize: 18, fontWeight: "900" }, pts: { color: "#233018", fontSize: 7, fontWeight: "900", letterSpacing: 1 }, challenge: { color: "#f3efe5", fontSize: 29, fontWeight: "900", marginTop: 23, letterSpacing: 0.2 }, desc: { color: "#9aa49e", fontSize: 14, lineHeight: 21, marginTop: 8, maxWidth: 500 }, divider: { height: 1, backgroundColor: "#253129", marginVertical: 18 }, done: { height: 50, borderRadius: 13, backgroundColor: "#b8d86a", flexDirection: "row", alignItems: "center", justifyContent: "center" }, doneText: { color: "#09100c", fontSize: 12, fontWeight: "900", letterSpacing: 1.5 }, arrow: { color: "#09100c", fontSize: 20, marginLeft: 10 },
  scoreBox: { width: "100%", marginTop: 14, padding: 12, borderRadius: 12, borderWidth: 1, borderColor: "#1f2a23", backgroundColor: "#0b100d", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, scoreLabel: { color: "#59665e", fontSize: 8, fontWeight: "900", letterSpacing: 1.4 }, scoreHint: { color: "#3f4b44", fontSize: 9, marginTop: 3 }, score: { color: "#b8d86a", fontSize: 22, fontWeight: "900", letterSpacing: 1 },
  finishWrap: { width: "100%", maxWidth: 620, alignSelf: "center", padding: 24, paddingBottom: 40 }, finishEyebrow: { color: "#c9a762", fontSize: 10, fontWeight: "900", letterSpacing: 2.2, marginTop: 40 }, finishTitle: { color: "#f3efe5", fontSize: 42, fontWeight: "900", marginTop: 8 }, finishSub: { color: "#6d7972", fontSize: 13, marginTop: 8 }, finalCard: { marginTop: 25, padding: 22, borderRadius: 18, backgroundColor: "#101612", borderWidth: 1, borderColor: "#29352e" }, finalLabel: { color: "#6d7972", fontSize: 9, fontWeight: "900", letterSpacing: 1.5 }, finalScore: { color: "#b8d86a", fontSize: 58, fontWeight: "900", marginTop: 3 }, statsRow: { flexDirection: "row", marginTop: 18, paddingTop: 17, borderTopWidth: 1, borderTopColor: "#253129" }, stat: { flex: 1 }, statValue: { color: "#f3efe5", fontSize: 18, fontWeight: "900" }, statLabel: { color: "#59665e", fontSize: 7, fontWeight: "900", letterSpacing: 1.1, marginTop: 3 }, section: { color: "#6d7972", fontSize: 9, fontWeight: "900", letterSpacing: 1.7 }, playerScore: { flexDirection: "row", alignItems: "center", padding: 13, borderRadius: 13, backgroundColor: "#0d130f", borderWidth: 1, borderColor: "#1f2a23", marginTop: 8 }, playerScoreTop: { borderColor: "#b8d86a" }, rank: { width: 31, height: 31, borderRadius: 16, backgroundColor: "#172019", alignItems: "center", justifyContent: "center", marginRight: 11 }, rankText: { color: "#69756e", fontSize: 9, fontWeight: "900" }, playerMeta: { color: "#59665e", fontSize: 9, marginTop: 3 }, playerPoints: { color: "#f3efe5", fontSize: 20, fontWeight: "900" }
});
